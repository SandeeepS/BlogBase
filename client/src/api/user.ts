...
export const getAllPost = async () => {
  try {
    ...
    console.log(
      "error occured while fetching all the blogs in the getAllPost",
      error
    );
    throw error;
  }
...
export const getPostByUserId = async (userId: string) => {
  try {
    const response = await Api.get(userRoutes.getPostByUserId, {
      params: { userId },
    });
    return response;
  } catch (error) {
...
export const getPostByBlogId = async (blogId: string) => {
  try {
    ...
    const response = await Api.get(userRoutes.getPostByBlogId, {
      params: { blogId },
    });
    return response;
  } catch (error) {
...
export const updatePost = async (blogId: string, updateData: IUpdateData) => {
  try {
    ...
    const response = await Api.put(userRoutes.updatePost, {
      blogId,
      updateData,
    });
    return response;
    ...
    console.log(
      "error while updating the post by blog id in updatePost ",
      error
    );
    throw error;
  }
...
export const deleteBlog = async (blogId: string) => {
  try {
    const response = await Api.put(userRoutes.deleteBlog, { blogId });
    return response;
  } catch (error) {
    console.log(
      "error occured while deleting the blog in the deleteBlog function  ",
      error
    );
    throw error;
  }
